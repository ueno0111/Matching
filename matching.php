...
////////////////////////////////////////////////データ登録終わり/////////////////////////////////////
  ...
  //データベースからSQL文を使い値を取得する　サンプル
	...
	//$dbh = new PDO($dsn, $user, $password);
	//$sql = 'SELECT * from user where name = "上野　豪"'; 
...
////////////////////////////ログインする際に必要でデータベースに接続する時の文///////////////////////////////////
	if($_GET["action"] == "user_login"){/////////////ログイン画面で入力した値が正しくGET送信された場合、データベースに接続することができる////////////////////
		try {
			$dsn = 'mysql:dbname=takeshiueno_database1;host=mysql1.php.xdomain.ne.jp';//データベース接続
			$user = 'takeshiueno_0111';
			$password = '5050Rock';
	...
	<section id="modalArea" class="modalArea">
		...
		<div class="modalWrapper">
			<div class="modalContents">
				...
				<form method="post" action="matching.php?action=user_insert" enctype="multipart/form-data"><!--登録ボタンを押した時に、上で書いたif文に経由される。正しければmatching.phpへ遷移する-->
...
　　　　　　<!--フリガナ-->
					...
					<input type="text" id="kana" name="kana" class="form-control" placeholder="例：ヤマダ　タロウ" autofocus required>　<!--required(必須）　入力チェックしてくれる。エラーメッセージを表示してくれる-->
					<br>
...
　　　　　　<!--フリガナ-->
	...
	<h1 class="main-visual7-left__register-prompt" >
		...
		<div class="top-Happy_Inner">
			<div class="top-Happy_Headline">
			</div>

			<div class="top-happy-content">
				<section class="top-Happy_Reports">
					...
					<section class="hr-AllReports_Item">
						...
						<h2 class="hr-AllReports_Info">
							<span class="hr-AllReports_Info">ゲームが趣味</span>
						</h2>
...
<!---------------------------------------レビュー　 終了------------------------------------------------------------>
	...
	<section class="step-3content">
		...
		<div class="area">
			<h1>ステップ3</h1>
			<h2>ご本人確認ができる身分証をご提出下さい<br>
			※顔写真の入っている身分証</h2>
			<img class="step-3content-img3"  src="driveID.png" alt="免許証">
		</div>
	</section>
	<!-----------------------------------------今すぐ登録して初めてみよう、会員登録方法 終了-------------------------------------------------->


	<!----------------------------------------------ご利用の流れ-------------------------------------------------------------------->
	<section class="main-visual">
	<h1 class="main-visual4-left__register-prompt">
				スピードマッチング<br>〜アプリご利用の流れ〜</br>
			</h1>
		<div class="main-visual-wrap2">
			<a name="link2"></a>
	...
	<button id="openModal3">ログインする</button>
		...
		<section id="modalArea3" class="modalArea3">
			...
			<div class="modalWrapper3">
				...
				<form method="post" action="matching.php?action=user_login"><!--actionに指定してある箇所にデータが送られる-->
					<!--メールアドレス-->
	...
	<section>
		...
		<div class="main2">
			<div class="contact-form">
				...
				<form method="post" action="matching.php?action=send"><!--matching.phpへ遷移する時の条件を指定-->
